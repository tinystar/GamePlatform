...
# add games data
INSERT INTO TGameKind(kindid, gamename, clientmodule, servermodule, version, sortfield)
...
# 经典斗地主
INSERT INTO TGamePlace(kindid, placeid, placename, placetype, enterlimit, basepoint)
...
# 经典斗地主-初级场
INSERT INTO TGameRoom(kindid, placeid, roomid, roomname, serverip, serverport, maxuser)
VALUES(1, 1, 1, "房间1", "127.0.0.1", 8001, 1200);
# 经典斗地主-中级场
INSERT INTO TGameRoom(kindid, placeid, roomid, roomname, serverip, serverport)
